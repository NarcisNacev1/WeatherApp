  ...
  <div class="search-container" :class="{ 'loading': weatherStore.isLoading }">
    <div class="city" :class="{ 'focused': isSearchFocused }">
      ...
      <div class="search-button" @click="searchCity" :class="{ 'active': weatherStore.city.trim() }">
        <svg v-if="!weatherStore.isLoading" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="11" cy="11" r="8"/>
          <line x1="21" y1="21" x2="16.65" y2="16.65"/>
        </svg>

        <!-- Loading spinner -->
        <svg v-else class="animate-spin" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
